...
**Definition:**  
Adam (Adaptive Moment Estimation) is an optimization algorithm that combines **Momentum** and **RMSProp**. It can increase or decrease the learning rate alpha depending on how fast or how slow we are descending unlike gradient descent where the learning rate is constant.  
